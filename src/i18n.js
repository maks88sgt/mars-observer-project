      ...
      en: {
        translation: {
          ...
          Login: {
            ...
            Login: "Login",
            "ApiKey Info":
              "This application makes requests to NASA's open API during its operation. " +
        ...
        translation: {
          ...
          Rovers: {
            Curiosity: {
              ...
              Description:
                "Его миссия началась в 2011 году и продолжается по сей день.",
          ...
          Login: {
            ...
            "ApiKey Info":
              "Это приложение во время своей работы делает запросы к открытому АПИ НАСА. " +
              "Для авторизации пользователей используется специальный ключ, который вы можете получить " +
              "по адресу ",
            "DemoKey Info":
              "Если по какой-либо причине вы не хотите регистрироваться, " +
